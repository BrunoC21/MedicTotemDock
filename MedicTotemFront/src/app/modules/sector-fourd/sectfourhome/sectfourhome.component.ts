...
@Component({
  selector: 'app-sectfourhome',
  templateUrl: './sectfourhome.component.html',
  styleUrls: ['./sectfourhome.component.css']
})
export class SectfourhomeComponent implements OnInit {
  content?: string;
  rutCorrecto=true;
  ...
  guardarRut(): void {
    ...
    if(dvverify == dv){
      ...
      this.rutGlobal.setDv4(dv);
      this.rutGlobal.setRut4(rutSinGuion);
      console.log('RUT guardado:', rutSinGuion);
      
      this.router.navigate(['sectfouroption']);
    }else{
