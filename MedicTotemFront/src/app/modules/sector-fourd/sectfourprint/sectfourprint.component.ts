...
@Component({
  selector: 'app-sectfourprint',
  templateUrl: './sectfourprint.component.html',
  styleUrls: ['./sectfourprint.component.css']
})
export class SectfourprintComponent implements OnInit {
