...
@Component({
  selector: 'app-secttwoprint',
  templateUrl: './secttwoprint.component.html',
  styleUrls: ['./secttwoprint.component.css']
})
export class SecttwoprintComponent implements OnInit {
