...
@Component({
  selector: 'app-sectoneprint',
  templateUrl: './sectoneprint.component.html',
  styleUrls: ['./sectoneprint.component.css']
})
export class SectoneprintComponent implements OnInit {
