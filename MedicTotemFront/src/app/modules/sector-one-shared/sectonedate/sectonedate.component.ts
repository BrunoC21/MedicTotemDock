...
@Component({
  selector: 'app-sectonedate',
  templateUrl: './sectonedate.component.html',
  styleUrls: ['./sectonedate.component.css']
})
export class SectonedateComponent implements OnInit {
  citas: any = [];
  sector: string = '1';
  cambios: any[] = [];
  ...
  constructor(private citaService: CitaService,
              private RutGlobalService: RutGlobalService,
              private ticketService: TicketService) {}

  ngOnInit(): void {
    const rut: string = this.RutGlobalService.getRut();
  ...
  guardarCambios(): void {
    ...
    this.cambios = [];
    // Limpiar la lista de cambios después de guardar
  }
