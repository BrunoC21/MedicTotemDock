...
@Component({
  selector: 'app-sectfiveprint',
  templateUrl: './sectfiveprint.component.html',
  styleUrls: ['./sectfiveprint.component.css']
})
export class SectfiveprintComponent implements OnInit {
