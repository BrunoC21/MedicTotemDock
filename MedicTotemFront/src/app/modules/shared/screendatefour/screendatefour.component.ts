...
@Component({
  selector: 'app-screendatefour',
  templateUrl: './screendatefour.component.html',
  styleUrls: ['./screendatefour.component.css']
})
export class ScreendatefourComponent implements OnInit, OnDestroy {
