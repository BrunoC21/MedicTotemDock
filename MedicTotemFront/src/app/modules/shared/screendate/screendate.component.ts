...
@Component({
  selector: 'app-screendate',
  templateUrl: './screendate.component.html',
  styleUrls: ['./screendate.component.css']
})
export class ScreendateComponent implements OnInit, OnDestroy {
