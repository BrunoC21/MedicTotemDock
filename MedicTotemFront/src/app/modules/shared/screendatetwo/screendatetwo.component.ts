...
@Component({
  selector: 'app-screendatetwo',
  templateUrl: './screendatetwo.component.html',
  styleUrls: ['./screendatetwo.component.css']
})
export class ScreendatetwoComponent implements OnInit, OnDestroy {
